...
public partial class ThreeBrothersMilkTeaShopContext : DbContext
{
	...
	protected override void OnModelCreating(ModelBuilder modelBuilder)
	{
		...
		{
			entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A2B2AAF6830");
		...
		{
			entity.HasKey(e => e.OrderId).HasName("PK__Orders__C3905BAF183F62F2");
		...
		{
			entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D30C809BD73F");
		...
		{
			entity.HasKey(e => e.Id).HasName("PK__OrderDet__3214EC274926225D");
		...
		{
			entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6EDD353BE05");
		...
		{
			entity.HasKey(e => e.ToppingId).HasName("PK__Toppings__EE02CCE52C8DE4F1");
		...
		{
			entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCACBFF2F0B0");

			entity.HasIndex(e => e.Username, "UQ__Users__536C85E4C680F145").IsUnique();
